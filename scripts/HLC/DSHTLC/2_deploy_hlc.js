...
async function main() {
    ...
    const epochTimePlus10Seconds = Date.now() + 60 * 1000;
    const epochTimeInSeconds = Math.floor(epochTimePlus10Hours / 1000);
    const epochTimeValidationInSeconds = Math.floor(epochTimePlus10Seconds / 1000);
    ...
    console.log(`Deploying HLC with the account:, ${admin.address}
        ...
        and epochTimeValidationInSeconds: ${epochTimeValidationInSeconds}`);
