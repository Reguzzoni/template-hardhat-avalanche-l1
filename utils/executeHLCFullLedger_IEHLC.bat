...
call npx hardhat run ./scripts/HLC/IEHLC/2_deploy_hlc.js

call npx hardhat run ./scripts/HLC/IEHLC/3_seller_transfer_token_to_hlc.js
call npx hardhat run ./scripts/HLC/IEHLC/4_buyer_transfer_token_to_hlc.js